...
module.exports.validateListing = (req, res, next) => {
  ...
  if (error) {
      ...
      console.log("Validation Error:", errMsg); // Logs the error to the console for debugging
      throw new ExpressErrors(400, errMsg); // Pass only the status code and message
  } else {
      next();
  }
};
